...
import { 
  ...
  HelpCircle, FileText, Radio, Settings, LogOut, Bell, ChevronDown, GraduationCap
} from 'lucide-react';
          ...
          <div style={{ 
            ...
            <div style={{ display: 'flex', alignItems: 'center', gap: '0.75rem' }}>
              ...
              <div style={{ overflow: 'hidden', textAlign: 'left' }}>
                <div style={{ fontWeight: 600, fontSize: '0.825rem', color: '#111827', textOverflow: 'ellipsis', whiteSpace: 'nowrap', width: '110px' }}>{user?.name || 'Renita Esther V'}</div>
        ...
        <header className="header" style={{ 
          ...
          <div style={{ display: 'flex', alignItems: 'center', gap: '1.25rem' }}>
            ...
            <div style={{ display: 'flex', gap: '0.25rem', fontSize: '0.7rem', opacity: 0.3 }}>
              ...
              <button onClick={() => { login('student'); navigate('/student'); }} style={{ border: 'none', background: 'none', cursor: 'pointer', color: '#6b7280' }}>S</button>
              ...
              <button onClick={() => { login('super_admin'); navigate('/super-admin/dashboard'); }} style={{ border: 'none', background: 'none', cursor: 'pointer', color: '#6b7280' }}>SA</button>
            </div>
          </div>
        </header>
